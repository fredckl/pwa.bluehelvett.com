<template>
<div>
  <div id="logo-svg" v-on:click="restart" class="p-3">
    <svg alt="bluehelvett - artisan digital" width="100%" height="100%" viewBox="0 0 289 35" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <p class="text-center text-grey-darkest mt-3 uppercase subtitle animated zoomIn delay-3s">
...
export default {
  ...
  beforeMount() {
    ...
    document.querySelector('#logo-svg').style.display = 'block'
